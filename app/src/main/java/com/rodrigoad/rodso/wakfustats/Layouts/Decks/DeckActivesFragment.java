...
public class DeckActivesFragment extends Fragment {
    ...
    private static DeckActivesFragment deckActivesFragment;
            ...
            switch (numero) {
                case 1:
                    if(ViewBuildActivity.build.getSpell1()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell1());
                        show=true;
                    }
                    break;
                case 2:
                    if(ViewBuildActivity.build.getSpell2()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell2());
                        show=true;
                    }
                    break;
                case 3:
                    if(ViewBuildActivity.build.getSpell3()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell3());
                        show=true;
                    }
                    break;
                case 4:
                    if(ViewBuildActivity.build.getSpell4()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell4());
                        show=true;
                    }
                    break;
                case 5:
                    if(ViewBuildActivity.build.getSpell5()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell5());
                        show=true;
                    }
                    break;
                case 6:
                    if(ViewBuildActivity.build.getSpell6()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell6());
                        show=true;
                    }
                    break;
                case 7:
                    if(ViewBuildActivity.build.getSpell7()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell7());
                        show=true;
                    }
                    break;
                case 8:
                    if(ViewBuildActivity.build.getSpell8()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell8());
                        show=true;
                    }
                    break;
                case 9:
                    if(ViewBuildActivity.build.getSpell9()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell9());
                        show=true;
                    }
                    break;
                case 10:
                    if(ViewBuildActivity.build.getSpell10()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell10());
                        show=true;
                    }
                    break;
                case 11:
                    if(ViewBuildActivity.build.getSpell11()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell11());
                        show=true;
                    }
                    break;
                case 12:
                    if(ViewBuildActivity.build.getSpell12()!=0) {
                        spell = spells.get(ViewBuildActivity.build.getSpell12());
                        show=true;
                    }
                    break;
            }
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        switch (numero) {
                            case 1:
                                ViewBuildActivity.build.setSpell1(0);
                                skill1.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 2:
                                ViewBuildActivity.build.setSpell2(0);
                                skill2.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 3:
                                ViewBuildActivity.build.setSpell3(0);
                                skill3.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 4:
                                ViewBuildActivity.build.setSpell4(0);
                                skill4.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 5:
                                ViewBuildActivity.build.setSpell5(0);
                                skill5.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 6:
                                ViewBuildActivity.build.setSpell6(0);
                                skill6.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 7:
                                ViewBuildActivity.build.setSpell7(0);
                                skill7.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 8:
                                ViewBuildActivity.build.setSpell8(0);
                                skill8.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 9:
                                ViewBuildActivity.build.setSpell9(0);
                                skill9.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 10:
                                ViewBuildActivity.build.setSpell10(0);
                                skill10.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 11:
                                ViewBuildActivity.build.setSpell11(0);
                                skill11.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                            case 12:
                                ViewBuildActivity.build.setSpell12(0);
                                skill12.setImageDrawable(GetImage(getContext(),spells.get(0).getImage()));
                                break;
                        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(rootView==null) {
            ...
            skill1.setOnClickListener(new showSpell(1));
            if(!ViewBuildActivity.build.isOnline())
            ...
            skill2.setOnClickListener(new showSpell(2));
            if(!ViewBuildActivity.build.isOnline())
            ...
            skill3.setOnClickListener(new showSpell(3));
            if(!ViewBuildActivity.build.isOnline())
            ...
            skill4.setOnClickListener(new showSpell(4));
            if(!ViewBuildActivity.build.isOnline())
            ...
            skill5.setOnClickListener(new showSpell(5));
            if(!ViewBuildActivity.build.isOnline())
            ...
            skill6.setOnClickListener(new showSpell(6));
            if(!ViewBuildActivity.build.isOnline())
            ...
            if(ViewBuildActivity.build.getNivel()>=10) {
                ...
                skill7.setOnClickListener(new showSpell(7));
                if(!ViewBuildActivity.build.isOnline())
                ...
                if(ViewBuildActivity.build.getNivel()>=20) {
                    ...
                    skill8.setOnClickListener(new showSpell(8));
                    if(!ViewBuildActivity.build.isOnline())
                    ...
                    if(ViewBuildActivity.build.getNivel()>=30) {
                        ...
                        skill9.setOnClickListener(new showSpell(9));
                        if(!ViewBuildActivity.build.isOnline())
                        ...
                        if(ViewBuildActivity.build.getNivel()>=40) {
                            ...
                            skill10.setOnClickListener(new showSpell(10));
                            if(!ViewBuildActivity.build.isOnline())
                            ...
                            if(ViewBuildActivity.build.getNivel()>=60) {
                                ...
                                skill11.setOnClickListener(new showSpell(11));
                                if(!ViewBuildActivity.build.isOnline())
                                ...
                                if(ViewBuildActivity.build.getNivel()>=80) {
                                    ...
                                    skill12.setOnClickListener(new showSpell(12));
                                    if(!ViewBuildActivity.build.isOnline())
            ...
            if(ViewBuildActivity.build.getClasse()==6){
                ...
                RelativeLayout.LayoutParams rlparams = (RelativeLayout.LayoutParams) hupper_ll.getLayoutParams();
                rlparams.height = RelativeLayout.LayoutParams.WRAP_CONTENT;
                hupper_ll.setLayoutParams(rlparams);
