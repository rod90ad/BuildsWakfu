...
import static com.rodrigoad.rodso.wakfustats.MainActivity.MY_PERMISSIONS_REQUEST_CAMERA;
...
public class BuildsFragment extends Fragment {
    ...
    public static void setRV(){
        RVAdapterBuilds adapterBuilds = new RVAdapterBuilds(new BD(context).getBuilds(),context);
